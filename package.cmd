...
copy src\SSU-CSharp\SSU.Api\bin\Release\*.* download\package\sportssignup\lib
copy src\SSU-CSharp\SSU.WinRT\bin\Release\*.* download\package\sportssignup-winrt\lib
